...
conv_varnames = {
    "tv": ["air_temperature_at_2m"],   #virtualTemperature"],
    "tsen": ["air_temperature_at_2m"],
    "uv": ["windEastward", "windNorthward"],
    "ps": ["stationPressure"],
    "q": ["specfic_humidity_at_2m"], #specificHumidity"],
    "bend": ["bendingAngle"],
...
geovals_vars = {
    ...
    'specfic_humidity_at_2m': 'specfic_humidity_at_2m',
    ...
    'air_temperature_at_2m': 'air_temperature_at_2m',
